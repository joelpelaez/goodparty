...
/**
 * removeOld: Remueve todo los elementos creados antes para preparar
 * el nuevo modelo.
 */
function removeOld() {
    $("#glcanvas").empty();
 ...
 */
function init(model_url, texture_path) {
    /**
    ...
    loadScene(model_url, texture_path);

}

function generateImage() {
    $("#download-preview").attr("href", canvas.toDataURL("image/png"));
}
